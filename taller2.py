...
while(volver == 0):
  ...
  match(Elección):
     ...
     case int(2):
       ...
       match(entrada):
         case int(1):
           print("bienvenido a compras de aplicaciones \n", "1. snapshap hd \n", "valor: 10000 \n " "2.cara libro ", "valor:37000 \n")
           print("3. tutube \n", "valor: 30000 \n " "4.pajaro x \n ", "valor:50000 \n","5.gpt 7 \n", " valor: 100000")
           entrada1 = int(input())
           match(entrada1):
             case int(1):
               print("felisitaciones por tu compra resibiste 10 puntos de bonificacion")
               puntos = puntos + 10
               datos4 = informacion(nombre,edad, tarjeta,vencimiento,contraseña,puntos)
             case int(2):
               print("felicitaciones por tu compra resibiste 20 puntos de bonificacion")
               puntos = puntos + 20
               datos4 = informacion(nombre,edad, tarjeta,vencimiento,contraseña,puntos)
             case int(3):
               print("felicitaciones por tu compra resibiste 40 puntos de bonificacion")
               puntos = puntos + 40
               datos4 = informacion(nombre,edad, tarjeta,vencimiento,contraseña,puntos)
             case int(4):
               print("felicitaciones por tu compra resibiste 5 puntos de bonificacion")
               puntos = puntos + 5
               datos4 = informacion(nombre,edad, tarjeta,vencimiento,contraseña,puntos)
             case int(5):
               print("felicitaciones por tu compra recibiste 25 puntos de bonificacion")
               puntos = puntos + 25
               datos4 = informacion(nombre,edad, tarjeta,vencimiento,contraseña,puntos)
         case int(2):
           ...
           if(total > 12):
             ...
             match(regalo):
               ...
               case int(2):
                 ...
                 datos4 = informacion(nombre,edad, tarjeta,vencimiento,contraseña,puntos)
                 total = datos4['puntos']
                 print("usted gano unos audifonos  ahora tiene ",total, " de puntos")
               case int(3):
                 puntos = total - 12
                 datos4 = informacion(nombre,edad, tarjeta,vencimiento,contraseña,puntos)
                 total = datos4['puntos']
               ...
               case int(4):
                 ...
                 datos4 = informacion(nombre,edad, tarjeta,vencimiento,contraseña,puntos)
                 total = datos4['puntos']
                 print("usted gano un drone ahora tiene ",total, " de puntos")
               case int(5):
                 puntos = total - 100
                 datos4 = informacion(nombre,edad, tarjeta,vencimiento,contraseña,puntos)
                 total = datos4['puntos']
